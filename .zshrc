...
export PATH=$PATH:/Users/tung/.npm-packages/bin
...
alias root="cd /"
alias qbp="cd ~/workspace/quench-business-platform"
alias qas="cd ~/workspace/quenchappserver"
alias pyc="cd ~/workspace/pick-your-court"
...
# Elements options of the left prompt (remove the @username context)
